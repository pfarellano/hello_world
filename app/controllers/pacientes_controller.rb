class PacientesController < ApplicationController
  ...
  private
    ...
    def paciente_params
      params.require(:paciente).permit(:nombre, :segundo_nombre, :apellido_paterno, :apellido_materno, :fecha_nacimiento, :rut, :direccion, :prevision, :telefono, :celular, :ocupacion, :ciudad)
    end
end
