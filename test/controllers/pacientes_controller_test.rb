...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { apellido_materno: @paciente.apellido_materno, apellido_paterno: @paciente.apellido_paterno, celular: @paciente.celular, ciudad: @paciente.ciudad, direccion: @paciente.direccion, fecha_nacimiento: @paciente.fecha_nacimiento, nombre: @paciente.nombre, ocupacion: @paciente.ocupacion, prevision: @paciente.prevision, rut: @paciente.rut, segundo_nombre: @paciente.segundo_nombre, telefono: @paciente.telefono } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { apellido_materno: @paciente.apellido_materno, apellido_paterno: @paciente.apellido_paterno, celular: @paciente.celular, ciudad: @paciente.ciudad, direccion: @paciente.direccion, fecha_nacimiento: @paciente.fecha_nacimiento, nombre: @paciente.nombre, ocupacion: @paciente.ocupacion, prevision: @paciente.prevision, rut: @paciente.rut, segundo_nombre: @paciente.segundo_nombre, telefono: @paciente.telefono } }
